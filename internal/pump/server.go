...
import (
	...
	"cooool-blog-api/internal/pump/pumps"
	"cooool-blog-api/internal/pump/storage"
	"cooool-blog-api/internal/pump/storage/redis"
...
func (s *pumpServer) BeforeRun() preparedPumpServer {
	s.initialize()
